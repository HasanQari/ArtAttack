...
<head>
    <!-- Title -->
    <title>Art Attack | CV Template</title>
    ...
    <section class="special-area bg-white section_padding_100" id="about">
        <div class="container">
            ...
            <div class="row">
                ...
                $query = $con->prepare("SELECT * FROM SERV_TEM_EDU WHERE file_type='cv'");
                $query->execute();
                    ...
                    <div class="col-12 col-md-4">
                        <div class="single-holder text-center wow fadeInUp" data-wow-delay="0.4s">
                            <div class="single-icon sImg single-SSS">
                                <img src="../../Resource/img/Services1/cv/<?php echo $row['file_name'] ?>.png">
