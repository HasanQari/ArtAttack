...
<div id="RPassHolder" class="popStyle">
    <div class="wrapperAuT fadeInDownAuT">
        <div class="formContent">
            ...
            <form>
                <input type="email" class="fadeInAuT fst inputAuT" name="email" placeholder="Email">
                <input type="submit" class="fadeInAuT trd AuTsubmit" value="Send">
            </form>
        </div>
    </div>
</div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-2">
                <div class="sing-Up-button d-none d-lg-block">
                    <a onclick="signup()" href="#SignUp">Sign Up Free</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-5 ml-xl-auto">
                    <div class="special_description_content">
                        ...
                        <br>
                        <p>You have already Account? <a id="login-INunder" onclick="login()">Sign-In</a></p>
                    </div>
                </div>
            </div>
        </div>
