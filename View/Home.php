...
//    ?>
    <!--Reg message-->
<!--    <div id="regsuc" class="popStyle" style="display: block">-->
<!--        <div class="wrapperAuT fadeInDownAuT">-->
<!--            <div class="formContent">-->
                <!-- Tabs Titles -->
<!--                <h2 class="signTitle active">Registered</h2>-->
<!--                <p>You're Register Successfully</p>-->
<!--                <p>Try to Login now!</p>-->
<!--                <button class="btn btn-light pointer" id="okBtn" onclick="okClose()"-->
<!--                        style="margin-bottom:5% ">Okay-->
<!--                </button>-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
...
if (isset($_SESSION['usermail'])) {
    require 'Layouts/loggedHead.php';
} else {
    require 'Layouts/unlogHead.php';
}
?>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="footer-text">
                    <p>We are happy to serve you and respond to your inquiries and you can contact us whenever you
                        like</p>
                </div>
                <div class="address-text">
                    <p><span>Address:</span> Umm Al-Qura Univarsity, Makkah, KSA</p>
                </div>
                <div class="phone-text">
                    <p><span>Phone:</span> +966-125270000</p>
                </div>
                <div class="email-text">
                    <p><span>Email:</span> ArtAttack@uqu.edu.sa</p>
                </div>
            </div>
            <div class="col-md-6">
                <!-- Form Start-->
