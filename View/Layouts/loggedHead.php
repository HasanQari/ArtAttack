        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-2">
                <div class="Cus d-none d-lg-block">
                    <a href="Profile.php"><?php echo "Hi " . $_SESSION['username']; ?></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <div class="single-feature">
                    ...
                    <ul>
                        <li><a href="services/Service2-1.php" class="ServList">Design Graduation and Success Parties</a>
                        </li>
                        <li><a href="services/Service2-2.html" class="ServList">Design Religious and Feasts
                                Occasions</a></li>
