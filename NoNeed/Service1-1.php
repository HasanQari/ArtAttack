...
<head>
    ...
    <link href="../Resource/Library/js/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
...
<section class="special-area bg-white section_padding_Container_resp" id="about">
    <div class="container">
        ...
        <div class="row">
            <div class="card-body card shadow mb-4 DesignArea" id="stage" >
...
<div class="toolBar section_padding_toolBar_resp">
    <div class="btnHolder">
        ...
        <button id="wallpaper" class="btnTool pointer" data-toggle="modal" data-target="#exampleModal-wall">Wallpaper</button>
        <button class="btnTool pointer" id="myBtn">Template</button>
    </div>
</div>
<!-- Modal (1) : -->
<div class="modal " id="exampleModal-pic" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
...
<div id="myModal" class="modal" tabindex="-1" role="dialog"  aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
        <button id="x-template" type="button" class="close" data-dismiss="true" >
        <span aria-hidden="true">&times;</span>
        </button>
        </div>
...
<script>
    ...
    $('#save-image').on('click', function () {
        ...
        $("#stage").resizable({handles: "all"});
        $("#stage").draggable({cursor: "move"});
    });
    ...
    function cpoy() {
        ...
        $(document).ready(function () {
            ...
            $("#test2").one("click", function () {
                ...
                userText.setAttribute("placeholder", "START A");
                stage.appendChild(userText);
                let inputText = document.getElementById("usertext");
                $("#usertext").change(function () {
                    let s = $("#usertext").innerHTML;
...
<script>
    ...
    $('#save-image').on('click', function () {
        ...
        $('#stage').html($('#stage').html() + '<img  href="' + svgImage.href + '" style="height: auto; width: 100%;"/> ')
        $("#stage").resizable({handles: "all"});
        $("#stage").draggable({cursor: "move"});
    });
...
<!--this script is for edit the graphics -->
<script>
...
<script src="../Resource/Library/js/svg.draggable.js"></script>
<!-- ***** Footer Area Start ***** -->
...
<!-- profile side -->
<script src="../Resource/Library/js/bootstrap.min.js"></script>
<script src="../Resource/Library/js/vendor/jquery/jquery.min.js"></script>

<script type="text/javascript" src="../Resource/Library/js/vendor/jquery"></script>
