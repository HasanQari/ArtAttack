...
function leverageNative( el, type, expectSync ) {
	...
	// RegisterController.php the controller as a special universal handler for all event namespaces
...
// RegisterController.php as a named AMD module, since jQuery can be concatenated with other
